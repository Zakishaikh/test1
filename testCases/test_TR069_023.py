...
class Test_TR069_025:
    ...
    def test_check_SSIDName_GUI(self, setup):
        ...
        if acs_set_value == 'PASS':
            ...
            adb_result = commonmethod.connectWifiAndroid11(ssid=Input_File.SSID_AP6[0], password=GUI_Pwd,
                                                           security='wpa2', r=0)
            print('adb result' + adb_result)

            if GUI_SSID == Input_File.SSID_AP6[0] and Packet_Analysis_Result == 'PASS' and adb_result == 'Connected':
                result = 'PASS'
            else:
                result = 'FAIL'
        else:
